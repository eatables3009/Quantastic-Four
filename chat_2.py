...
HOST = '192.168.184.136'  # Loopback address
PORT = 5555
...
pil_image = Image.open("C:\coding\photos\Send_Image_6.png")
...
#message_entry = tk.Entry(root, width=350,height = 30,placeholder_text = "Type here")
